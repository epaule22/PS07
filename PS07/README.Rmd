...
It turns out, if you try to plot by x = date, that Presidents Truman, Eisenhower, Kennedy, and Johnson all gave speeches through 2068, so I organized by number of presidency instead. 
